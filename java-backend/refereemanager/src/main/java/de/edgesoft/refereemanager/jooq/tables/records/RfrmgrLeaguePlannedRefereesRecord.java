...
public class RfrmgrLeaguePlannedRefereesRecord extends UpdatableRecordImpl<RfrmgrLeaguePlannedRefereesRecord> implements Record5<UInteger, UInteger, UInteger, UInteger, UInteger> {

    private static final long serialVersionUID = -450449470;
    ...
    public Field<UInteger> field1() {
        return RfrmgrLeaguePlannedReferees.RFRMGR_LEAGUE_PLANNED_REFEREES.ID;
    }
    ...
    public Field<UInteger> field2() {
        return RfrmgrLeaguePlannedReferees.RFRMGR_LEAGUE_PLANNED_REFEREES.LEAGUE_ID;
    }
    ...
    public Field<UInteger> field3() {
        return RfrmgrLeaguePlannedReferees.RFRMGR_LEAGUE_PLANNED_REFEREES.SEASON_ID;
    }
    ...
    public Field<UInteger> field4() {
        return RfrmgrLeaguePlannedReferees.RFRMGR_LEAGUE_PLANNED_REFEREES.REFEREE_ASSIGNMENT_TYPE_ID;
    }
    ...
    public Field<UInteger> field5() {
        return RfrmgrLeaguePlannedReferees.RFRMGR_LEAGUE_PLANNED_REFEREES.QUANTITY;
    }
     ...
     */
    @Override
    public RfrmgrLeaguePlannedRefereesRecord value1(UInteger value) {
        setId(value);
        return this;
    }
     ...
     */
    @Override
    public RfrmgrLeaguePlannedRefereesRecord value2(UInteger value) {
        setLeagueId(value);
        return this;
    }
     ...
     */
    @Override
    public RfrmgrLeaguePlannedRefereesRecord value3(UInteger value) {
        setSeasonId(value);
        return this;
    }
     ...
     */
    @Override
    public RfrmgrLeaguePlannedRefereesRecord value4(UInteger value) {
     ...
     */
    @Override
    public RfrmgrLeaguePlannedRefereesRecord value5(UInteger value) {
        setQuantity(value);
        return this;
    }
     ...
     */
    @Override
    public RfrmgrLeaguePlannedRefereesRecord values(UInteger value1, UInteger value2, UInteger value3, UInteger value4, UInteger value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    /**
     * Create a detached RfrmgrLeaguePlannedRefereesRecord
     */
    public RfrmgrLeaguePlannedRefereesRecord() {
        super(RfrmgrLeaguePlannedReferees.RFRMGR_LEAGUE_PLANNED_REFEREES);
    }

    /**
     * Create a detached, initialised RfrmgrLeaguePlannedRefereesRecord
     */
    public RfrmgrLeaguePlannedRefereesRecord(UInteger id, UInteger leagueId, UInteger seasonId, UInteger refereeAssignmentTypeId, UInteger quantity) {
        super(RfrmgrLeaguePlannedReferees.RFRMGR_LEAGUE_PLANNED_REFEREES);
