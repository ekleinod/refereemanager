...
public class SeasonsRecord extends UpdatableRecordImpl<SeasonsRecord> implements Record5<UInteger, Integer, String, Byte, String> {

    private static final long serialVersionUID = 173397776;
     ...
     */
    @Override
    public Row5<UInteger, Integer, String, Byte, String> fieldsRow() {
     ...
     */
    @Override
    public Row5<UInteger, Integer, String, Byte, String> valuesRow() {
     ...
     */
    @Override
    public SeasonsRecord values(UInteger value1, Integer value2, String value3, Byte value4, String value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SeasonsRecord(UInteger id, Integer yearStart, String title, Byte editorOnly, String remark) {
        super(Seasons.SEASONS);
