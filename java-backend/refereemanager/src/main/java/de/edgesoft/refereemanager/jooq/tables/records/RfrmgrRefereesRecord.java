...
public class RfrmgrRefereesRecord extends UpdatableRecordImpl<RfrmgrRefereesRecord> implements Record3<UInteger, UInteger, Byte> {

    private static final long serialVersionUID = 1187368222;
    ...
    public Field<UInteger> field1() {
        return RfrmgrReferees.RFRMGR_REFEREES.ID;
    }
    ...
    public Field<UInteger> field2() {
        return RfrmgrReferees.RFRMGR_REFEREES.PERSON_ID;
    }
    ...
    public Field<Byte> field3() {
        return RfrmgrReferees.RFRMGR_REFEREES.DOCS_PER_LETTER;
    }
     ...
     */
    @Override
    public RfrmgrRefereesRecord value1(UInteger value) {
        setId(value);
        return this;
    }
     ...
     */
    @Override
    public RfrmgrRefereesRecord value2(UInteger value) {
        setPersonId(value);
        return this;
    }
     ...
     */
    @Override
    public RfrmgrRefereesRecord value3(Byte value) {
     ...
     */
    @Override
    public RfrmgrRefereesRecord values(UInteger value1, UInteger value2, Byte value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
    ...
    /**
     * Create a detached RfrmgrRefereesRecord
     */
    public RfrmgrRefereesRecord() {
        super(RfrmgrReferees.RFRMGR_REFEREES);
    }

    /**
     * Create a detached, initialised RfrmgrRefereesRecord
     */
    public RfrmgrRefereesRecord(UInteger id, UInteger personId, Byte docsPerLetter) {
        super(RfrmgrReferees.RFRMGR_REFEREES);
