...
/**
 * Person reference model, additional methods for jaxb model class.
 *
 * ## Legal stuff
 *
 ...
 * @since 0.15.0
 */
public class PersonReferenceModel extends PersonReference {
	...
	public StringProperty getDisplayText() {
		return getPerson().getDisplayText();
	}
