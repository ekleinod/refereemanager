...
public class RefereeCommunication extends AbstractMainClass {
	...
	public void refereeCommunication(final Path theDBPath, final Path theTextPath, final String theOutputPath,
		...
		try {
			...
			switch (theAction) {
				case DOCUMENT:
					pathTemplate = Paths.get(Prefs.get(PrefKey.PATH_TEMPLATES), Prefs.get(PrefKey.DOCUMENTS_TEMPLATE_DOCUMENT));
				...
				case LETTER:
					pathTemplate = Paths.get(Prefs.get(PrefKey.PATH_TEMPLATES), Prefs.get(PrefKey.EMAIL_TEMPLATE_LETTER));
				...
				case MAIL:
					pathTemplate = Paths.get(Prefs.get(PrefKey.PATH_TEMPLATES), Prefs.get(PrefKey.EMAIL_TEMPLATE_EMAIL));
