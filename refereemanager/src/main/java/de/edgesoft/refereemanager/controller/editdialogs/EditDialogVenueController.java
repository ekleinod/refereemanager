 ...
 * @since 0.15.0
 */
public class EditDialogVenueController extends AbstractTabbedEditDialogController<Venue> {

	/**
	 * Titled id controller.
	 */
	@FXML
	private IInputFormController<Venue> embeddedInputFormTitledIDTypeController;
...
//	private IInputFormController<Venue> embeddedInputFormAddressController;
	 ...
	 */
	@FXML
	private IInputFormController<Venue> embeddedInputFormGeolocationController;
