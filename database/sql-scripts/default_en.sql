...
UPDATE `rfrmgr_league_game_team_types` SET `title`='off team', `abbreviation`='off' WHERE `sid`='home';
...
UPDATE `rfrmgr_status_types` SET `title`='not active', `style`=NULL, `color`='BBBBBB', `bgcolor`='EEEEEE', `remark`='The referee is not active.' WHERE `sid`='inactive';
