...
UPDATE `rfrmgr_status_types` SET `title`='not active, receives emails only', `style`=NULL, `color`='777777', `bgcolor`=NULL, `remark`='The referee is not active but receives referees emails.' WHERE `sid`='mailonly';
